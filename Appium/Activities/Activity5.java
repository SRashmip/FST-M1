...
public class Activity5 {
    ...
    @Test
    public void smsTest() {
    	String plusicon = "resourceId(\"com.google.android.apps.messaging:id/start_new_conversation_button\")";
        // Wait for elements to load
        wait.until(ExpectedConditions.elementToBeClickable(MobileBy.AndroidUIAutomator(plusicon)));
        // Locate the button to write a new message and click it
        driver.findElement(MobileBy.AndroidUIAutomator(plusicon)).click();
